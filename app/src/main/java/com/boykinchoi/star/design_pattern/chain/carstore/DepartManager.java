 ...
 */
public class DepartManager implements Manager {
    ...
    public void permission(Buyer buyer) {
        ...
        if (permission) {
            buyer.setManagerPermissionBuy(true);
            System.out.println("我是经理，您希望的价钱" + buyer.bidPrice() + "是不，我这边没问题，但要向boss请示一下哈");
            if (nextManager != null) {
                nextManager.permission(buyer);
            }
        } else {
            System.out.println("经理:没钱就别来买");
        }
